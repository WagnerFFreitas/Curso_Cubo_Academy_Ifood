...
var palavras = ["javascript", "html", "css", "programação", "desenvolvimento", "web", "backend", "frontend", "código", "git", "API", "framework", "biblioteca", "responsivo", "debugging", "interface", "repositório", "deploy", "testes", "prototipagem"];
...
// Este bloco exibe as partes do enforcado com base no número de tentativas restantes no jogo da forca
function exibirenforcado() {
  ...
  //A linha abaixo limpa as partes do enforcado anteriores no jogo da forca
  pessoaEnforcadaElement.innerHTML = "";

  // A partir daqui sao as classes correspondentes às partes enforcadas do jogo daq forca
...
// Este bloco atualiza a exibição do estado atual do jogo da forca
...
// Este bloco verifica se o jogador venceu o jogo da forca
...
// A linha abaixo inicia a exibição do estado do jogo da forca
exibirestadojogo();
